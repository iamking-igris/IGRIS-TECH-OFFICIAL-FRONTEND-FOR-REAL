...
import { c as emptyEcosystemInput, g as useEcosystem, h as useContentHydrated, n as ECOSYSTEM_STATUSES, o as ecosystemService, s as ecosystemToInput } from "./router-ZY7VAfYm2.mjs";
import { a as StatusMark, i as SelectInput, n as CheckRow, o as TextArea, r as Field, s as TextInput, t as AdminEmpty } from "./fields-BhPnEFGH.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { n as AdminPending } from "./admin-gate-CFJKXS2i.mjs";
import { t as ConfirmDialog } from "./confirm-dialog-BPb7esTL.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ecosystem-D7haMDiY.js
...
function EcosystemAdmin() {
	...
	if (!hydrated) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminPending, { children: "Loading ecosystem" });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Name, details, link, status. Keep it small — this is not a CMS for marketing pages."
				})
		...
		editing ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: editing === "new" ? "New product" : `Edit ${editing.name}`
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mt-8",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EcosystemForm, {
					initial: editing === "new" ? {
						...emptyEcosystemInput(),
		...
		items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminEmpty, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-2 font-mono text-[10px] tracking-wider text-faint",
								children: item.url ?? item.subdomain
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusMark, {
							tone: item.published ? "ink" : "quiet",
							children: item.published ? "PUBLISHED" : "HIDDEN"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusMark, { children: item.status.toUpperCase() })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-wrap gap-2 md:col-span-3 md:justify-end",
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConfirmDialog, {
			...
			body: pendingDelete ? `“${pendingDelete.name}” will be removed from the ecosystem list in this browser.` : "",
...
function EcosystemForm({ initial, submitLabel, onSubmit, onCancel }) {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Field, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectInput, {
						...
						children: ECOSYSTEM_STATUSES.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
							value: s,
							children: s
						}, s))
					})
...
//#endregion
export { EcosystemAdmin as component };
