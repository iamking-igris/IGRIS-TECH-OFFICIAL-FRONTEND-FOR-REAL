...
import { A as FUTURE_PRODUCTS_NOTE, N as listPublicProjects, _ as cn, f as services, g as ButtonLink, m as Container, s as organizationJsonLd, u as websiteJsonLd, w as useFeaturedProjects } from "./router-LJGBwkzE.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BSrACA4W.js
...
function GlobalNetworkGlobe({ className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "pointer-events-none absolute inset-x-4 top-3 sm:inset-x-5 sm:top-4 flex items-center justify-between z-20 font-mono text-[8px] sm:text-[9px] uppercase tracking-[0.14em] sm:tracking-[0.18em] text-faint",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "flex items-center gap-1.5",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "inline-block h-1 w-1 bg-ink/60 rounded-full animate-pulse" }), GLOBE_LABELS.topLeft]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-faint/70",
					children: GLOBE_LABELS.topRight
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "pointer-events-none absolute inset-x-4 bottom-3 sm:inset-x-5 sm:bottom-4 flex items-center justify-between z-20 font-mono text-[8px] sm:text-[9px] uppercase tracking-[0.14em] sm:tracking-[0.18em] text-faint",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-faint/80",
					children: GLOBE_LABELS.bottomLeft
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-faint/70",
					children: GLOBE_LABELS.bottomRight
				})]
			})
		]
	});
