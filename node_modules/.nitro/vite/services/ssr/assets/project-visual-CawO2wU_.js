...
//#region src/components/projects/project-visual.tsx
function ProjectVisual({ visual, imageUrl, className, interactive = true, caption }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 hex-grid opacity-30" }),
				visual === "alpha" && /* @__PURE__ */ jsx(Alpha, {}),
				visual === "beta" && /* @__PURE__ */ jsx(Beta, {}),
				visual === "gamma" && /* @__PURE__ */ jsx(Gamma, {}),
				imageUrl && !imgError && /* @__PURE__ */ jsx("img", {
					src: imageUrl,
					alt: "",
