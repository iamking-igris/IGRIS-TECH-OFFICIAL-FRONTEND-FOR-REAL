...
import { a as serviceJsonLd, l as absoluteUrl, t as breadcrumbJsonLd } from "./seo-CU7LXOqa.js";
...
import { t as ProcessSection } from "./process-section-DPmsKxDg.js";
import { t as servicesFaq } from "./faq-BqQC9f8a.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/services/service-page.tsx
function ServicePage({ service }) {
	const related = useFeaturedProjects().filter((p) => p.services.includes(service.slug));
	return /* @__PURE__ */ jsxs("main", {
		id: "main",
		children: [
			/* @__PURE__ */ jsx(JsonLd, { data: serviceJsonLd(service.name, service.description, absoluteUrl(service.href)) }),
				...
				children: /* @__PURE__ */ jsxs(Container, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("ul", {
								className: "mt-6",
								children: service.points.map((point) => /* @__PURE__ */ jsx("li", {
			...
			related.length > 0 && /* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs(Container, {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						className: "mt-8",
						children: related.map((project) => /* @__PURE__ */ jsx("li", {
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs(Container, {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						className: "mt-8",
						children: servicesFaq.map((item) => /* @__PURE__ */ jsxs("div", {
