...
import { a as contactService, i as TIMELINES, n as CONTACT_METHODS, r as PROJECT_TYPES, t as BUDGETS } from "./contact-BCtBp8Jv.js";
import { t as breadcrumbJsonLd } from "./seo-CU7LXOqa.js";
import { t as PageHeader } from "./page-header-InNPX9q0.js";
import { t as JsonLd } from "./json-ld-IR7igJk0.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/contact/contact-form.tsx
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("label", {
					...
					className: "grid gap-2 text-sm",
					children: [/* @__PURE__ */ jsx("span", { children: "Email" }), /* @__PURE__ */ jsx("input", {
						name: "email",
						type: "email",
						autoComplete: "email",
						required: true,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("label", {
					className: "grid gap-2 text-sm",
					children: [/* @__PURE__ */ jsxs("span", { children: ["Company / Brand ", /* @__PURE__ */ jsx("span", {
					...
					className: "grid gap-2 text-sm",
					children: [/* @__PURE__ */ jsxs("span", { children: ["Existing website / product ", /* @__PURE__ */ jsx("span", {
						className: "text-faint",
						children: "(optional)"
					})] }), /* @__PURE__ */ jsx("input", {
						name: "website",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("label", {
					className: "grid gap-2 text-sm",
					children: [/* @__PURE__ */ jsx("span", { children: "Project type" }), /* @__PURE__ */ jsxs("select", {
						name: "type",
						required: true,
						defaultValue: "",
						className: field,
						children: [/* @__PURE__ */ jsx("option", {
							...
							disabled: true,
							children: "Select one"
						}), PROJECT_TYPES.map((t) => /* @__PURE__ */ jsx("option", {
							value: t,
							children: t
						}, t))]
					})]
					...
					className: "grid gap-2 text-sm",
					children: [/* @__PURE__ */ jsxs("span", { children: ["Preferred contact ", /* @__PURE__ */ jsx("span", {
						className: "text-faint",
						children: "(optional)"
						...
						}), CONTACT_METHODS.map((t) => /* @__PURE__ */ jsx("option", {
							value: t,
							children: t
						}, t))]
					})]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("label", {
					className: "grid gap-2 text-sm",
					children: [/* @__PURE__ */ jsxs("span", { children: ["Timeline ", /* @__PURE__ */ jsx("span", {
						className: "text-faint",
						children: "(optional)"
					})] }), /* @__PURE__ */ jsxs("select", {
						name: "timeline",
						...
						children: [/* @__PURE__ */ jsx("option", {
							value: "",
							children: "Select if you can"
						}), TIMELINES.map((t) => /* @__PURE__ */ jsx("option", {
							value: t,
							children: t
						}, t))]
					})]
					...
					className: "grid gap-2 text-sm",
					children: [/* @__PURE__ */ jsxs("span", { children: ["Budget ", /* @__PURE__ */ jsx("span", {
						className: "text-faint",
						children: "(optional)"
					})] }), /* @__PURE__ */ jsxs("select", {
						name: "budget",
						...
						children: [/* @__PURE__ */ jsx("option", {
							value: "",
							children: "Select if you can"
						}), BUDGETS.map((t) => /* @__PURE__ */ jsx("option", {
							value: t,
							children: t
						}, t))]
					})]
			...
			/* @__PURE__ */ jsxs("label", {
				className: "grid gap-2 text-sm",
				children: [/* @__PURE__ */ jsx("span", { children: "Project description" }), /* @__PURE__ */ jsx("textarea", {
					name: "description",
					required: true,
					className: area,
...
function ContactPage() {
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("section", { children: /* @__PURE__ */ jsxs(Container, {
