import { a as updateProject } from "./store-BjAP6kxP.js";
import { a as projectToInput, c as useProjectById, o as projectsService } from "./projects-Dck77_K-.js";
import { l as useContentHydrated, n as Route } from "./router-LJGBwkzE.js";
import { n as AdminPending } from "./admin-gate-DitP9PCx.js";
import { t as ProjectForm } from "./project-form-BJ1lRR-B.js";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
//#region src/routes/admin/projects/$id.tsx?tsr-split=component
function EditProject() {
	const { id } = Route.useParams();
	const hydrated = useContentHydrated();
	const project = useProjectById(id);
	const navigate = useNavigate();
	if (!hydrated) return /* @__PURE__ */ jsx(AdminPending, { children: "Loading project" });
	if (!project) return /* @__PURE__ */ jsxs("div", { children: [
		/* @__PURE__ */ jsx("p", {
		...
		/* @__PURE__ */ jsxs(Link, {
			...
			children: ["Back to projects", /* @__PURE__ */ jsx("span", {
				className: "btn-arrow",
				"aria-hidden": true,
				children: "→"
			})]
