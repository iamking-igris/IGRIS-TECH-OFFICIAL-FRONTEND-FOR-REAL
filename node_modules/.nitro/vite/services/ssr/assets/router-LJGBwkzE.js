...
import { o as subscribeAuth, t as useContentStore } from "./store-BjAP6kxP.js";
import { o as projectsService } from "./projects-Dck77_K-.js";
import { n as services, t as getService } from "./services-CsiE3ino.js";
import { c as SITE, i as pageHead, s as NAV } from "./seo-CU7LXOqa.js";
...
//#endregion
//#region src/lib/content/ecosystem.ts
...
function useEcosystem() {
	...
	return useMemo(() => [...ecosystem].sort((a, b) => a.order - b.order), [ecosystem]);
}
function usePublishedEcosystem() {
	const ecosystem = useContentStore((s) => s.ecosystem);
	return useMemo(() => [...ecosystem].filter((p) => p.published).sort((a, b) => a.order - b.order), [ecosystem]);
}
//#endregion
...
//#endregion
//#region src/components/footer/site-footer.tsx
function SiteFooter() {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Link, {
						...
						children: ["Start a Project", /* @__PURE__ */ jsx("span", {
							className: "btn-arrow",
							"aria-hidden": true,
							children: "→"
						})]
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
						...
						className: "space-y-3 text-sm",
						children: ecosystemProducts.map((p) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
							to: "/ecosystem",
							hash: p.slug,
							className: "text-ink/90 hover:text-ink",
							children: p.name
...
//#endregion
//#region src/components/navigation/site-nav.tsx
function SiteNav() {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(Link, {
						...
						children: /* @__PURE__ */ jsx(BrandLockup, {})
					}),
					/* @__PURE__ */ jsxs("nav", {
					...
					/* @__PURE__ */ jsxs("button", {
						...
						onClick: () => setOpen((v) => !v),
						children: [
							/* @__PURE__ */ jsx("span", { className: cn("absolute h-px w-5 bg-ink transition-transform duration-200", open ? "translate-y-0 rotate-45" : "-translate-y-1.5") }),
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("nav", {
					...
					"aria-label": "Mobile",
					children: [NAV.map((item, i) => /* @__PURE__ */ jsxs(Link, {
						to: item.to,
...
//#endregion
//#region src/components/page/site-grid.tsx
function SiteGrid() {
...
function SiteShell({ children }) {
	if (useRouterState({ select: (s) => s.location.pathname }).startsWith("/admin")) return /* @__PURE__ */ jsx(Fragment, { children });
...
//#endregion
//#region src/components/page/not-found.tsx
function NotFoundPage() {
	...
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 hex-grid opacity-50" }), /* @__PURE__ */ jsxs(Container, {
	...
	return /* @__PURE__ */ jsxs("html", {
		...
		children: [/* @__PURE__ */ jsx("head", { children: /* @__PURE__ */ jsx(HeadContent, {}) }), /* @__PURE__ */ jsxs("body", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs(AuthProvider, { children: [/* @__PURE__ */ jsx(ContentHydrator, {}), /* @__PURE__ */ jsx(SiteShell, { children: /* @__PURE__ */ jsx(Outlet, {}) })] }),
...
var $$splitComponentImporter$22 = () => import("./routes-BSrACA4W.js");
...
var $$splitComponentImporter$21 = () => import("./about-w7NzONa5.js");
...
var $$splitComponentImporter$20 = () => import("./admin-Dd3pnMeh.js");
...
var $$splitComponentImporter$19 = () => import("./contact-CrzVjyln.js");
...
//#endregion
//#region src/routes/ecosystem.tsx
var $$splitComponentImporter$18 = () => import("./ecosystem-C4p4v3ii.js");
...
var $$splitComponentImporter$17 = () => import("./privacy-lQgRegOx.js");
...
var $$splitComponentImporter$16 = () => import("./review-B1poEn1M.js");
...
var $$splitComponentImporter$15 = () => import("./terms-R509Gb4v.js");
...
var $$splitComponentImporter$14 = () => import("./admin-eCLJFW4e.js");
...
//#endregion
//#region src/routes/admin/ecosystem.tsx
var $$splitComponentImporter$13 = () => import("./ecosystem-D-A0XUqO.js");
...
//#endregion
//#region src/routes/admin/inquiries.tsx
var $$splitComponentImporter$12 = () => import("./inquiries-OQXEQTz0.js");
...
//#endregion
//#region src/routes/admin/projects.tsx
var $$splitComponentImporter$11 = () => import("./projects-CAnMb2fW.js");
...
var $$splitComponentImporter$10 = () => import("./reviews-SbltytRS.js");
...
var $$splitComponentImporter$9 = () => import("./services-Dt_f1W3U.js");
...
//#endregion
//#region src/routes/services/ai-solutions.tsx?tsr-shared=1
var service$3 = getService("ai-solutions");
//#endregion
//#region src/routes/services/ai-solutions.tsx
var $$splitComponentImporter$8 = () => import("./ai-solutions-3fHgyvoy.js");
...
//#endregion
//#region src/routes/services/automation.tsx?tsr-shared=1
var service$2 = getService("automation");
//#endregion
//#region src/routes/services/automation.tsx
var $$splitComponentImporter$7 = () => import("./automation-C7_ZYAb4.js");
...
//#endregion
//#region src/routes/services/software-development.tsx?tsr-shared=1
var service$1 = getService("software-development");
//#endregion
//#region src/routes/services/software-development.tsx
var $$splitComponentImporter$6 = () => import("./software-development-CpGRzeL1.js");
...
//#endregion
//#region src/routes/services/web-development.tsx?tsr-shared=1
var service = getService("web-development");
//#endregion
//#region src/routes/services/web-development.tsx
var $$splitComponentImporter$5 = () => import("./web-development-CYWHe0UN.js");
...
//#endregion
//#region src/routes/work/index.tsx
var $$splitComponentImporter$4 = () => import("./work-C_7JsyBF.js");
...
//#endregion
//#region src/routes/work/$slug.tsx
var $$splitComponentImporter$3 = () => import("./_slug-vGAiTkKN.js");
...
//#endregion
//#region src/routes/admin/projects/index.tsx
var $$splitComponentImporter$2 = () => import("./projects-CHUxWtVi.js");
...
//#endregion
//#region src/routes/admin/projects/$id.tsx
var $$splitComponentImporter$1 = () => import("./_id-BWgQJ5gx.js");
...
//#endregion
//#region src/routes/admin/projects/new.tsx
var $$splitComponentImporter = () => import("./new-C9RM6OYu.js");
...
//#endregion
export { service$1 as a, NotFoundPage as c, ecosystemService as d, ecosystemToInput as f, BrandLockup as g, getRouter, usePublishedEcosystem as h, service as i, useContentHydrated as l, useEcosystem as m, Route$1 as n, service$2 as o, emptyEcosystemInput as p, Route$3 as r, service$3 as s, router_exports as t, ECOSYSTEM_STATUSES as u };
