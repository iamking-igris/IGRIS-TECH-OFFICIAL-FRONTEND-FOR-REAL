...
import { n as ButtonLink } from "./button-link-DuD0WsTl.js";
import { t as Container } from "./container-CGk6eJJy.js";
import { c as FUTURE_PRODUCTS_NOTE, i as listPublicProjects } from "./store-BjAP6kxP.js";
import { s as useFeaturedProjects } from "./projects-Dck77_K-.js";
import { r as usePublishedReviews } from "./reviews-DcTRiFDH.js";
import { n as services } from "./services-CsiE3ino.js";
import { o as websiteJsonLd, r as organizationJsonLd } from "./seo-CU7LXOqa.js";
import { h as usePublishedEcosystem } from "./router-RsAy9zmm.js";
import { t as CtaBand } from "./cta-band-DnOAzWzz.js";
import { t as JsonLd } from "./json-ld-IR7igJk0.js";
import { t as StatusChip } from "./status-chip-DXl3zibr.js";
import { n as Reveal, t as ProcessSection } from "./process-section-DPmsKxDg.js";
import { t as ProjectRow } from "./project-row-N035qr0N.js";
import { useEffect, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import * as THREE from "three";
//#region src/components/about/about-section.tsx
			...
			children: [/* @__PURE__ */ jsxs(Reveal, {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("ul", {
						...
						children: [
							/* @__PURE__ */ jsx("li", { children: "Build for clients." }),
							/* @__PURE__ */ jsx("li", { children: "Learn from every project." }),
							/* @__PURE__ */ jsx("li", { children: "Create what comes next." })
						]
					}),
					/* @__PURE__ */ jsxs(Link, {
						to: "/about",
						className: "mt-10 inline-flex items-center gap-2 text-sm text-coal",
						children: ["About the company", /* @__PURE__ */ jsx("span", {
							className: "btn-arrow",
							"aria-hidden": true,
							children: "→"
						})]
...
//#endregion
//#region src/components/page/section-header.tsx
...
//#endregion
//#region src/components/ecosystem/ecosystem-section.tsx
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [ecosystemProducts.map((product, i) => /* @__PURE__ */ jsxs("li", {
							id: product.slug,
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									}), /* @__PURE__ */ jsx(StatusChip, { children: product.status.toUpperCase() })]
								}),
								/* @__PURE__ */ jsx("h3", {
				...
				/* @__PURE__ */ jsxs(Link, {
					...
					children: ["The ecosystem", /* @__PURE__ */ jsx("span", {
						className: "btn-arrow",
						"aria-hidden": true,
						children: "→"
					})]
...
//#endregion
//#region src/components/hero/world-land-data.ts
...
//#endregion
//#region src/components/hero/global-network-globe.tsx
var NETWORK_HUBS = [
	{
		id: "LHR",
		name: "London",
...
function GlobalNetworkGlobe({ className }) {
	...
	const [activeNode, setActiveNode] = useState("SYSTEM / ACTIVE");
	useEffect(() => {
		...
		const coreGeometry = new THREE.SphereGeometry(GLOBE_RADIUS * .996, 48, 48);
		const coreMaterial = new THREE.ShaderMaterial({
			vertexShader: sphereCoreVertexShader,
			fragmentShader: sphereCoreFragmentShader,
			uniforms: {
				uBaseColor: { value: new THREE.Color(460553) },
				uRimColor: { value: new THREE.Color(15987696) },
		...
		const gridMaterial = new THREE.ShaderMaterial({
			...
			uniforms: {
				uColor: { value: new THREE.Color(6052952) },
				uOpacity: { value: .2 }
			},
			transparent: true,
			depthTest: true
		...
		const equatorMaterial = new THREE.ShaderMaterial({
			...
			fragmentShader: sphericalLineFragmentShader,
			uniforms: {
				uColor: { value: new THREE.Color(9276808) },
				uOpacity: { value: .3 }
			},
			transparent: true,
			depthTest: true
		...
		const landPointMaterial = new THREE.ShaderMaterial({
			...
			uniforms: {
				uColor: { value: new THREE.Color(12500664) },
				uOpacity: { value: .48 },
				uSize: { value: 2 }
			},
			transparent: true,
		...
		hubGeom.setAttribute("position", new THREE.Float32BufferAttribute(hubPositions, 3));
		const hubPointMaterial = new THREE.ShaderMaterial({
			vertexShader: sphericalPointVertexShader,
			fragmentShader: sphericalPointFragmentShader,
			uniforms: {
				uColor: { value: new THREE.Color(15987696) },
				uOpacity: { value: .95 },
				uSize: { value: 3.8 }
			},
			transparent: true,
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(243,243,240,0.03)_0%,transparent_65%)]" }),
			/* @__PURE__ */ jsx("canvas", {
				ref: canvasRef,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: "inline-block h-1 w-1 bg-ink/60 rounded-full animate-pulse" }), "SYSTEM / GLOBAL"]
				}), /* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/components/hero/home-hero.tsx
function HomeHero() {
	return /* @__PURE__ */ jsxs("section", {
		className: "relative overflow-hidden border-b border-hairline",
		children: [/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 hex-grid opacity-40 md:opacity-20" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: /* @__PURE__ */ jsx(GlobalNetworkGlobe, { className: "h-full w-full" })
			})]
		})]
	});
}
//#endregion
//#region src/hooks/useRemoteFeaturedProjects.tsx
...
//#endregion
//#region src/components/projects/work-section.tsx
		...
		children: /* @__PURE__ */ jsxs(Container, {
			...
			children: [
				...
				loading ? /* @__PURE__ */ jsx("p", {
					...
					children: items.map((project, i) => /* @__PURE__ */ jsx(ProjectRow, {
						project,
						index: i,
						reverse: i % 2 === 1
					}, project.slug))
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs(Link, {
						...
						children: ["All work", /* @__PURE__ */ jsx("span", {
							className: "btn-arrow",
							"aria-hidden": true,
							children: "→"
						})]
...
//#endregion
//#region src/components/services/services-section.tsx
		...
		children: /* @__PURE__ */ jsxs(Container, {
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(SectionHeader, {
				...
				children: [/* @__PURE__ */ jsx("ul", {
					className: "md:col-span-7",
					children: services.map((service, i) => /* @__PURE__ */ jsx("li", {
...
//#endregion
//#region src/components/testimonials/reviews-section.tsx
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs(Container, {
			...
			children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(SectionHeader, {
				...
				children: items.map((review) => /* @__PURE__ */ jsxs("li", {
...
function Home() {
	return /* @__PURE__ */ jsxs("main", {
		id: "main",
		children: [
			/* @__PURE__ */ jsx(JsonLd, { data: organizationJsonLd() }),
			/* @__PURE__ */ jsx(JsonLd, { data: websiteJsonLd() }),
			...
			/* @__PURE__ */ jsx(CtaBand, { kicker: "Contact / 07" })
		]
	});
}
//#endregion
